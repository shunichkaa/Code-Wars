// Given a height map as a 2D array of integers, return the volume of liquid that it could contain.
// For example:
// heightmap:
// 8 8 8 8 6 6 6 6
// 8 0 0 8 6 0 0 6
...
// 8 8 8 8 6 6 6 0
// result: 4*8 + 4*6 = 56
// For this heightmap, you would return 56:
// were you to pour water over it until it couldn't contain any more, it would look like the second heightmap,
// taking on 56 units of water in the process.
...
// Heightmaps in the test cases will come in many different sizes, and some will be quite large, but they will always be rectangular.
// Heights may be negative.

// I need you to implement a function called float2bin that converts a float number to the corresponding 32-bit binary value.
// This involves analysing each part of the input number and appointing each bit of the output accordingly.
// See visual explanation from wiki below:
// IEEE754 visual
// Rules:
...
// Since there always is some rounding inaccuracy when working with floats, the last 5 characters in the output will not be checked.
// This is done using something similar to the approx function in the test fixture.
